...
Inspired by [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,759 | 🐛 106 | 📅 2026-08-21 list and [donnemartin/awesome-aws](https://github.com/donnemartin/awesome-aws) ⭐ 14,128 | 🐛 101 | 🌐 Python | 📅 2024-03-12.
...
* :green\_heart:[K9s](https://github.com/derailed/k9s) ⭐ 34,425 | 🐛 98 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - K9s provides a terminal UI to interact with your Kubernetes clusters.
* :green\_heart:[Helm](https://github.com/helm/helm) ⭐ 30,174 | 🐛 456 | 🌐 Go | 📅 2026-08-24 :fire::fire::fire::fire::fire: - Helm is a tool for managing Charts. Charts are packages of pre-configured Kubernetes resources.
* :green\_heart:[kubectx + kubens](https://github.com/ahmetb/kubectx) ⭐ 19,957 | 🐛 40 | 🌐 Go | 📅 2026-08-02 :fire::fire::fire::fire::fire: - `kubectx` helps you switch between clusters back and forth, and `kubens` helps you switch between Kubernetes namespaces smoothly.
...
* :green\_heart:[stern](https://github.com/stern/stern) ⭐ 4,847 | 🐛 41 | 🌐 Go | 📅 2026-08-19 :fire::fire::fire::fire::fire: - Stern allows you to tail multiple pods on Kubernetes and multiple containers within the pod.
...
* :green\_heart:[kubectl tree](https://github.com/ahmetb/kubectl-tree) ⭐ 3,418 | 🐛 16 | 🌐 Go | 📅 2026-08-24 :fire::fire::fire::fire: - A kubectl plugin to explore ownership relationships between Kubernetes objects through owners.
...
* :green\_heart:[kapp](https://github.com/vmware-tanzu/carvel-kapp) ⭐ 1,075 | 🐛 128 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire: - kapp is a simple deployment tool focused on the concept of "Kubernetes application" — a set of resources with the same label
...
* :green\_heart:[k3s](https://github.com/rancher/k3s) ⭐ 33,811 | 🐛 71 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Lightweight Kubernetes. Easy to install,Kubernetes clusters from the command line.
* :green\_heart:[Minikube](https://github.com/kubernetes/minikube) ⭐ 32,059 | 🐛 542 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - minikube implements a local Kubernetes cluster on macOS,Linux,all in a binary less than 100 MB.
* :green\_heart:[kubespray](https://github.com/kubernetes-sigs/kubespray) ⭐ 18,702 | 🐛 203 | 🌐 Jinja | 📅 2026-08-21 :fire::fire::fire::fire::fire: - Deploy a production ready Kubernetes cluster
* :green\_heart:[kops](https://github.com/kubernetes/kops) ⭐ 16,668 | 🐛 133 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - `kops` helps you create,like kind,upgrade and maintain production-grade
* :green\_heart:[kind](https://github.com/kubernetes-sigs/kind) ⭐ 15,448 | 🐛 244 | 🌐 Go | 📅 2026-08-21 :fire::fire::fire::fire::fire: - kind is a tool for running local Kubernetes clusters using Docker container "nodes".
* :green\_heart:[vCluster](https://github.com/loft-sh/vcluster/) ⭐ 11,269 | 🐛 152 | 🌐 Go | 📅 2026-08-24 : :fire::fire::fire::fire::fire: - vCluster allows you to create fully functional virtual Kubernetes clusters, drastically reducing costs and improving multi-tenancy and isolation compared to traditional Kubernetes.
* :green\_heart:[Talos Linux](https://github.com/siderolabs/talos) ⭐ 11,013 | 🐛 213 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Talos Linux is a minimal, immutable, secure OS that installs vanilla Kubernetes - for production datacenters, K8s\@home, and Edge.
* :green\_heart:[microK8s](https://github.com/ubuntu/microk8s) ⭐ 9,356 | 🐛 164 | 🌐 Python | 📅 2026-08-22 :fire::fire::fire::fire::fire: - The smallest, fastest Kubernetes
...
* :green\_heart:[k0s](https://github.com/k0sproject/k0s) ⭐ 6,447 | 🐛 209 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - k0s - Zero Friction Kubernetes (The Simple, Solid & Certified Kubernetes Distribution)
...
* :green\_heart:[Cluster API](https://github.com/kubernetes-sigs/cluster-api) ⭐ 4,289 | 🐛 218 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Cluster API is a Kubernetes sub-project focused on providing declarative APIs and tooling to simplify provisioning, upgrading, and operating multiple Kubernetes clusters.
...
* :green\_heart:[Claudie](https://github.com/berops/claudie) ⭐ 790 | 🐛 67 | 🌐 Go | 📅 2026-08-25 :fire: - Multi-cloud clusters with each nodepool in a different cloud provider.
...
* :green\_heart:[Argo CD](https://github.com/argoproj/argo-cd) ⭐ 23,990 | 🐛 4,399 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Argo CD is a declarative, GitOps continuous delivery tool for Kubernetes.
...
* :green\_heart:[Argo Workflows](https://github.com/argoproj/argo) ⭐ 16,936 | 🐛 1,265 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Argo Workflows is an open source container-native workflow engine for orchestrating parallel jobs on Kubernetes.
...
* :green\_heart:[Reloader](https://github.com/stakater/Reloader) ⭐ 10,362 | 🐛 164 | 🌐 Go | 📅 2026-08-23 :fire::fire::fire::fire::fire: - Reloader can watch changes in `ConfigMap` and `Secret` and do rolling upgrades on Pods with their associated `DeploymentConfigs`, `Deployments`, `Daemonsets` and `Statefulsets`.
...
* :green\_heart:[Flux2](https://github.com/fluxcd/flux2) ⭐ 8,370 | 🐛 251 | 🌐 Go | 📅 2026-08-09 :fire::fire::fire::fire::fire: - Flux version 2 is built from the ground up to use Kubernetes' API extension system, and to integrate with Prometheus and other core components of the Kubernetes ecosystem.
...
* :green\_heart:[Argo Rollouts](https://github.com/argoproj/argo-rollouts) ⭐ 3,561 | 🐛 661 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire: - Argo Rollouts controller, uses the Rollout custom resource to provide additional deployment strategies such as Blue Green and Canary to Kubernetes.
...
* :green\_heart:[Otomi - Self-hosted PaaS for K8s](https://github.com/redkubes/otomi-core) ⭐ 2,258 | 🐛 63 | 🌐 Go Template | 📅 2026-08-25 :fire::fire::fire::fire: - Otomi adds developer- and operations-centric tools, automation, and developer self-service on top of Kubernetes in any infrastructure or cloud, to code, build, release, deploy, secure, operate and monitor containerized applications.
  :green\_heart:[Cozystack - Self-hosted PaaS for K8s](https://github.com/cozystack/cozystack) ⭐ 2,202 | 🐛 625 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire: - a turnkey, self-hosted PaaS built to run on hardened Talos Linux clusters, bringing security-first Kubernetes automation to your own metal. Perfect if you're building sovereign cloud or edge-native stacks.
...
* :green\_heart: [Meshery](https://github.com/meshery/meshery) ⭐ 11,571 | 🐛 1,829 | 🌐 TypeScript | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Meshery is an open-source cloud-native manager that enables the design and management of all Kubernetes-based infrastructure and applications.
...
* :green\_heart:[Grafana Tanka](https://github.com/grafana/tanka) ⭐ 2,682 | 🐛 61 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire: - The clean, concise and super flexible alternative to YAML for your Kubernetes cluster.
...
* :green\_heart:[Liqo](https://github.com/liqotech/liqo) ⭐ 1,479 | 🐛 110 | 🌐 Go | 📅 2026-08-25 :fire::fire: - Liqo implements Dynamic resource sharing across different Kubernetes clusters (e.g.; offloading pods and services), supporting decentralized governance.
...
* :green\_heart:[cilium](https://github.com/cilium/cilium) ⭐ 25,007 | 🐛 1,097 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Cilium is a networking, observability, and security solution with an eBPF-based dataplane.
...
* :green\_heart:[cert-manager](https://github.com/jetstack/cert-manager) ⭐ 14,049 | 🐛 241 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - cert-manager is a Kubernetes add-on to automate the management and issuance of TLS certificates from various issuing sources.
* :green\_heart:[Calico Networking](https://github.com/projectcalico/calico) ⭐ 7,334 | 🐛 253 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Calico is an open source networking and network security solution for containers, virtual machines, and bare-metal workloads
* :green\_heart:[kubernetes-ingress](https://github.com/nginxinc/kubernetes-ingress) ⭐ 5,067 | 🐛 243 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire:  - An implementation of an Ingress controller for NGINX and NGINX Plus (commercial).
...
* :green\_heart:[kube-ovn](https://github.com/alauda/kube-ovn) ⭐ 2,393 | 🐛 80 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire:  - A Kubernetes Network Fabric for Enterprises that is Rich in Functions and Easy in Operations.
...
* :green\_heart:[loxilb](https://github.com/loxilb-io/loxilb) ⭐ 1,871 | 🐛 31 | 🌐 Go | 📅 2026-08-19 :fire::fire::fire:  - A Kubernetes service load-balancer based on eBPF.
...
* :green\_heart:[OpenEBS](https://github.com/openebs/openebs) ⭐ 9,799 | 🐛 39 | 📅 2026-08-25 :fire::fire::fire::fire::fire: - OpenEBS is the most widely deployed and easy to use open-source storage solution for Kubernetes.
* :green\_heart:[Longhorn](https://github.com/longhorn/longhorn) ⭐ 7,930 | 🐛 1,864 | 🌐 Shell | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Longhorn is a distributed block storage system for Kubernetes.

### Testing and Troubleshooting

* :green\_heart:[k6](https://github.com/loadimpact/k6) ⭐ 31,314 | 🐛 794 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - k6 is a modern load testing tool, building on Load Impact's years of experience in the load and performance testing industry.
...
* :green\_heart:[Litmus](https://github.com/litmuschaos/litmus) ⭐ 5,601 | 🐛 394 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Litmus provides tools to orchestrate chaos on Kubernetes to help SREs find weaknesses in their deployments.
* :green\_heart:[ksniff](https://github.com/eldadru/ksniff) ⭐ 3,473 | 🐛 67 | 🌐 Go | 📅 2024-08-02 :fire::fire::fire::fire: - A kubectl plugin that utilize tcpdump and Wireshark to start a remote capture on any pod in your Kubernetes cluster.
...
* :green\_heart:[Chainsaw](https://github.com/kyverno/chainsaw) ⭐ 612 | 🐛 71 | 🌐 Go | 📅 2026-07-28 :fire: - The ultimate end to end testing tool for Kubernetes operators.
...
* :green\_heart:[Grafana](https://github.com/grafana/grafana) ⭐ 76,404 | 🐛 3,305 | 🌐 TypeScript | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Grafana allows you to query, visualize, alert on and understand your metrics no matter where they are stored.
* :green\_heart:[Prometheus](https://github.com/prometheus/prometheus) ⭐ 65,812 | 🐛 913 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Prometheus, a Cloud Native Computing Foundation project, is a systems and service monitoring system.
* :green\_heart:[Lens](https://github.com/lensapp/lens) ⭐ 23,227 | 🐛 1,169 | 📅 2025-02-11 :fire::fire::fire::fire::fire: - Lens it's an useful, attractive, open source user interface (UI) for working with Kubernetes clusters.
...
* :green\_heart:[Thanos](https://github.com/thanos-io/thanos) ⭐ 14,185 | 🐛 879 | 🌐 Go | 📅 2026-08-24 :fire::fire::fire::fire::fire: - Thanos is a set of components that can be composed into a highly available metric system with unlimited storage capacity.
* :green\_heart:[Mizu](https://github.com/up9inc/mizu) ⭐ 12,056 | 🐛 146 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire: - API traffic viewer for Kubernetes enabling you to view all API communication between microservices. Think TCPDump and Wireshark re-invented for Kubernetes
...
* :green\_heart:[kube-state-metrics](https://github.com/kubernetes/kube-state-metrics) ⭐ 6,184 | 🐛 106 | 🌐 Go | 📅 2026-08-23 :fire::fire::fire::fire::fire: - kube-state-metrics is a simple service that listens to the Kubernetes API server and generates metrics about the state of the objects.
...
* :green\_heart:[Kiali](https://github.com/kiali/kiali) ⭐ 3,632 | 🐛 82 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Kiali works with Istio to visualise the service mesh topology.
...
* :green\_heart:[Canary Checker](https://github.com/flanksource/canary-checker) ⭐ 341 | 🐛 128 | 🌐 Go | 📅 2026-08-25 :fire: - Canary Checker is a kubernetes-native health check platform with 30+ built-in health check types.
...
* :green\_heart:[Velero](https://github.com/vmware-tanzu/velero) ⭐ 10,253 | 🐛 833 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Velero (formerly Heptio Ark) gives you tools to back up and restore your Kubernetes cluster resources and persistent volumes.
...
* :green\_heart:[Teleport](https://github.com/gravitational/teleport) ⭐ 20,846 | 🐛 3,388 | 🌐 Go | 📅 2026-08-24 :fire::fire::fire::fire::fire: - Teleport Unified Access Plane enables engineers to quickly access any computing resource anywhere.
...
* :green\_heart:[Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,069 | 🐛 641 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire: - Kyverno is a policy engine designed for Kubernetes. It can validate, mutate, and generate configurations using admission controls and background scans.
...
* :green\_heart:[Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,268 | 🐛 192 | 🌐 Go | 📅 2026-08-24 :fire::fire::fire::fire::fire: - Policy controller for Kubernetes
...
* :green\_heart:[Istio](https://github.com/istio/istio) ⭐ 38,356 | 🐛 502 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - An open platform to connect, manage, and secure microservices.
...
* :green\_heart:[ko](https://github.com/google/ko) ⭐ 8,507 | 🐛 56 | 🌐 Go | 📅 2026-08-24 :fire::fire::fire::fire::fire: - `ko` is a tool for building and deploying Golang applications to Kubernetes.
* :green\_heart:[Telepresence](https://github.com/telepresenceio/telepresence) ⭐ 7,287 | 🐛 26 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Telepresence provides fast, realistic local development for Kubernetes microservices.
* :green\_heart:[mirrord](https://github.com/metalbear-co/mirrord) ⭐ 5,274 | 🐛 71 | 🌐 Rust | 📅 2026-08-25 :fire::fire::fire::fire::fire: - mirrord connects your local process and your cloud environment, and runs local code in cloud conditions.
...
* :green\_heart:[Strimzi](https://github.com/strimzi/strimzi-kafka-operator) ⭐ 5,915 | 🐛 152 | 🌐 Java | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Strimzi provides a way to run an Apache Kafka cluster on Kubernetes or OpenShift in various deployment configurations.
* :green\_heart:[Volcano](https://github.com/volcano-sh/volcano) ⭐ 5,894 | 🐛 804 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire: - Volcano is a batch system built on Kubernetes.
* :green\_heart:[yunikorn](https://github.com/apache/incubator-yunikorn-core) ⭐ 1,023 | 🐛 11 | 🌐 Go | 📅 2026-08-25 :fire::fire: - a light-weight, universal resource scheduler for container orchestrator systems.
...
* :green\_heart:[Crossplane](https://github.com/crossplane/crossplane) ⭐ 11,976 | 🐛 188 | 🌐 Go | 📅 2026-08-25 :fire::fire::fire::fire::fire: - Crossplane is an open source Kubernetes add-on that extends any cluster with the ability to provision and manage cloud infrastructure, services, and applications.
...
* :green\_heart:[Agones](https://github.com/googleforgames/agones) ⭐ 6,989 | 🐛 63 | 🌐 Go | 📅 2026-08-24 :fire::fire::fire::fire::fire: - Agones is a library for hosting, running and scaling dedicated game servers on Kubernetes.
