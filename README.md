...
* :green\_heart:[Plural](https://github.com/pluralsh/plural) ⭐ 1,506 | 🐛 52 | 🌐 HTML | 📅 2026-09-25 :fire::fire: - Plural is a CLI tool and holistic DevOps management platform for rapidly deploying, managing, and monitoring open-source applications on Kubernetes.
...
* 💚[kubecolor](https://github.com/kubecolor/kubecolor) ⭐ 1,467 | 🐛 16 | 🌐 Go | 📅 2026-09-22 🔥🔥🔥 - colorizes kubectl output
...
* :green\_heart:[Claudie](https://github.com/berops/claudie) ⭐ 794 | 🐛 58 | 🌐 Go | 📅 2026-09-25 :fire: - Multi-cloud clusters with each nodepool in a different cloud provider.
...
* :green\_heart:[Sealed Secrets](https://github.com/bitnami-labs/sealed-secrets) ⭐ 9,291 | 🐛 67 | 🌐 Go | 📅 2026-09-23 :fire::fire::fire::fire::fire: - Encrypt your Secret into a SealedSecret, which is safe to store - even to a public repository.
...
* :green\_heart:[Canary Checker](https://github.com/flanksource/canary-checker) ⭐ 346 | 🐛 127 | 🌐 Go | 📅 2026-09-25 :fire: - Canary Checker is a kubernetes-native health check platform with 30+ built-in health check types.
